...
## Corpus Check
- 352 files · ~134,729 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1954 nodes · 5002 edges · 176 communities (117 shown, 59 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 201 edges (avg confidence: 0.79)
...
- `makeConsignment()` --calls--> `UpJurusan`  [INFERRED]
  tests/Unit/ConsignmentTransitionServiceTest.php → app/Models/UpJurusan.php

## Import Cycles
- None detected.

## Communities (176 total, 59 thin omitted)
...
Cohesion: 0.08
Nodes (37): InputError(), Props, Props, PasswordInput(), Button(), buttonVariants, Checkbox(), Input() (+29 more)
...
Cohesion: 0.07
Nodes (4): UpJurusanDailyReportTransaction, UpJurusanDailyReportTransactionItem, UpJurusanStockMovement, Illuminate\Database\Eloquent\Relations\BelongsTo

### Community 9 - "Product"
Cohesion: 0.20
Nodes (3): AdminProductModerationController, BuyerProductDetailController, Product

### Community 11 - "OrderItem"
Cohesion: 0.09
Nodes (8): OrderItem, OrderItemCancellation, OrderItemFulfillment, up(), up(), OrderItemStatus, settlementOrder(), makePaymentItem()
...
Cohesion: 0.12
Nodes (4): PicketUpJurusanConsignmentController, UpJurusanPosSale, TransactionCode, up()
...
Cohesion: 0.20
Nodes (3): UpJurusan, UpJurusanPolicy, ActorLifecycle
...
Cohesion: 0.12
Nodes (5): label(), options(), Category, Illuminate\Database\Eloquent\Factories\HasFactory, Illuminate\Foundation\Configuration\Middleware
...
Cohesion: 0.07
Nodes (29): HeaderNotification, notificationMenuStyle, roleLabels, Heading(), Props, ManageTwoFactor(), Props, Props (+21 more)

### Community 20 - "two-factor-setup-modal.tsx"
Cohesion: 0.20
Nodes (3): UpJurusanConsignment, ConsignmentTransitionService, UpJurusanConsignmentStatus

### Community 21 - "dropdown-menu.tsx"
Cohesion: 0.09
Nodes (25): NavUser(), DropdownMenu(), DropdownMenuCheckboxItem(), DropdownMenuContent(), DropdownMenuGroup(), DropdownMenuItem(), DropdownMenuLabel(), DropdownMenuRadioItem() (+17 more)

### Community 23 - "User"
Cohesion: 0.10
Nodes (10): SellerDashboardController, User, OrderPolicy, UserPolicy, Illuminate\Foundation\Auth\User, Illuminate\Notifications\Notifiable, Laravel\Fortify\Contracts\PasskeyUser, Laravel\Fortify\PasskeyAuthenticatable (+2 more)
...
Cohesion: 0.07
Nodes (40): AppSidebar(), getMainNavItems(), lightTooltip, NavFooter(), NavMain(), Separator(), Sidebar(), SidebarContent() (+32 more)

### Community 26 - "sidebar.tsx"
Cohesion: 0.16
Nodes (6): OrderPaymentSync, OrderStatusSync, PaymentTransitionService, up(), up(), PaymentStatus
...
Cohesion: 0.09
Nodes (23): @base-ui/react, class-variance-authority, @laravel/passkeys, laravel-vite-plugin, dependencies, @base-ui/react, class-variance-authority, @laravel/passkeys (+15 more)

### Community 30 - "OrderLivenessService"
Cohesion: 0.14
Nodes (6): AdminOrderController, Order, OrderLivenessService, OrderSettlementService, Carbon\CarbonInterface, Illuminate\Database\Eloquent\Builder
...
Cohesion: 0.07
Nodes (16): AdminJurusanConsignmentController, AdminProductController, AdminSellerApplicationController, AdminUserController, BuyerCatalogController, BuyerOrderController, Controller, NotificationDismissalController (+8 more)
...
Cohesion: 0.13
Nodes (9): SellerApplicationController, SellerApplication, CategoryFactory, OrderFactory, OrderItemFactory, SellerApplicationFactory, UpJurusanConsignmentFactory, UpJurusanFactory (+1 more)
...
Cohesion: 0.10
Nodes (14): DailyReport, DateTimeProps, EmptyStateProps, formatRupiah(), Props, ReportHeaderProps, ReportsSection(), ReportsSectionProps (+6 more)
...
Cohesion: 0.26
Nodes (4): DatabaseSeeder, TestingUserSeeder, Illuminate\Database\Console\Seeds\WithoutModelEvents, Illuminate\Database\Seeder
...
- **Why does `cn()` connect `cn` to `categories/index.tsx`, `StockMovementSource.php`, `button.tsx`, `utils.ts`, `use-clipboard.ts`, `confirm.tsx`, `auth-simple-layout.tsx`, `app-header.tsx`, `up-jurusan/index.tsx`, `breadcrumbs.tsx`, `dropdown-menu.tsx`, `chart.tsx`, `index.ts`, `app-sidebar.tsx`, `2026_07_01_000004_add_pre_order_fields_to_products.php`, `alert.tsx`?**
  _High betweenness centrality (0.051) - this node is a cross-community bridge._
- **Why does `User` connect `User` to `FortifyServiceProvider.php`, `Illuminate\Foundation\Http\FormRequest`, `Illuminate\Database\Eloquent\Relations\BelongsTo`, `Illuminate\Database\Eloquent\Relations\HasMany`, `OrderItem`, `OrderItemStatus.php`, `Illuminate\Http\Request`, `UpJurusan`, `Product.php`, `two-factor-setup-modal.tsx`, `sidebar.tsx`, `OrderLivenessService`, `Illuminate\Http\RedirectResponse`, `Illuminate\Database\Eloquent\Model`, `UpJurusanDailyReport`, `AdminDashboardController`, `ProductCatalogSeeder`, `HandleInertiaRequests`, `StoreProductRequest`, `setup`, `Illuminate\Console\Command`, `class-variance-authority`, `receiving.tsx`?**
  _High betweenness centrality (0.033) - this node is a cross-community bridge._
- **Why does `Button()` connect `button.tsx` to `categories/index.tsx`, `cn`, `admin-jurusan/dashboard.tsx`, `card.tsx`, `utils.ts`, `StockMovementSource.php`, `use-clipboard.ts`, `confirm.tsx`, `reports/index.tsx`, `2026_06_30_000002_add_completed_to_order_items_status.php`, `app-header.tsx`, `up-jurusan/index.tsx`, `app-sidebar.tsx`?**
